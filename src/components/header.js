        ...
        <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-10">
            <div className="relative">
              ...
              <button
                type="button"
                onClick={() => setIsSolutionActive(!isSolutionActive)}
                className={`${
                  isSolutionActive ? 'text-gray-900' : 'text-gray-500'
              ...
              >
                ...
                <svg
                  className={`${
                    isSolutionActive ? 'text-gray-600' : 'text-gray-400'
        ...
        --> */}
            ...
            <div className="relative">
              ...
              >
                ...
                <svg
                  className={`${
                    isMoreActive ? 'text-gray-600' : 'text-gray-400'
                  } h-5 w-5 group-hover:text-gray-500 group-focus:text-gray-500 transition ease-in-out duration-150`}
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
